                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建"
                                            onclick="location.href='${pageContext.request.contextPath}/product/pages/product-add.jsp'">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick="location.href='${pageContext.request.contextPath}/orders/findAll.do?id=${product.id}'">订单详情</button>
                                    </td>
                                </tr>
                            </c:forEach>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <%--循环页数--%>
                            <c:forEach items="${pageInfo.pages}" var="pageNew">
                                <li><a href="${pageContext.request.contextPath}/product/findAll.do?page=${pageNew}&size=${pageInfo.pageSize}">${pageNew}</a></li>
                            </c:forEach>

                            <%--pageInfo.pageSize+1(当前页数量+1)   pageInfo.pageSize（当前页数量）--%>
